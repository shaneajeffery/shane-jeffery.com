const DeviceSizeIndicator = ({ enable }) => {
    if (process.env.NODE_ENV === 'development' && enable) {
        return (
            <div className="font-mono bg-gray-700 lg:bg-green-500 fixed bottom-0 left-0 z-50 m-2 flex h-6 w-6 items-center justify-center rounded-full p-3 text-xs text-white sm:bg-pink-500 md:bg-orange-500 xl:bg-blue-500">
