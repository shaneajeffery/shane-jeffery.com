            ...
            <div className="container">
                <div className="relative flex items-center justify-between py-6">
                    ...
                    <nav
                        ...
                        style={{
                            height: mobileNavClose
                                ? 'auto'
                                : 42 + mainMenuLength * 40 + 'px',
                        }}
                    >
                        {indicatorPosition && (
                            <span
                    ...
                    >
                        <svg
                            className={
                                mobileNavClose ? '' : '-translate-x-[3rem]'
                            }
                    ...
                    <div
                        className={`text-sm hidden w-1/4 text-right transition-all duration-300 lg:block ${isScrolled ? 'lg:translate-x-8 lg:opacity-0' : ''}`}
                    >
                        <span className="mb-1 block text-white/75">
                            Social Links:
                        </span>
